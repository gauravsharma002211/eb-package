...
<div class="wrapper">
    ...
    <?php /*----- header 시작 -----*/ ?>
    <header class="header-wrap header-wrap-custom <?php if(!defined('_INDEX_')) { ?>page-header-wrap<?php } ?>">
        <div class="top-header">
            <div class="container">
                ...
                <button class="mobile_button d-lg-none">
                P2U내역
                </button>
                        <ul class="top-header-nav list-unstyled thn-start d-none">
                    ...
                    <div class="col-lg-9 clearfix d-none d-lg-block">
                        <div class="d-flex align-items-center ms-auto justify-content-end top-header-right">
                        ...
                        <?php } ?>
                            ...
                            <div class="header-title-search d-none d-lg-block">
                                <form name="fsearchbox" method="get" action="<?php echo G5_BBS_URL; ?>/search.php" onsubmit="return fsearchbox_submit(this);" class="eyoom-form eyoom-form-search">
                                ...
                                <label for="modal_sch_stx" class="sound_only"><strong>검색어 입력 필수</strong></label>
                                    <div class="input input-button mb-0">
                                        ...
                                        <div class="button"><input type="submit"><i class="fas search-icon">
                                        <img src="<?php echo EYOOM_THEME_URL; ?>/image/icons/search-md.svg" class="search-icon" alt="<?php echo $config['cf_title']; ?>">
                                        </i></div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="header-title d-none">
            <div class="container">
                ...
                <div class="header-title-search d-none">
        ...
        <div class="nav-wrap site-menu-bar">
            <div class="container">
                <nav class="navbar navbar-expand-lg">
                    <div class="sidebar-left offcanvas offcanvas-start" tabindex="-1" id="offcanvasLeft" aria-controls="offcanvasLeftLabel">
                        <div class="sidebar-left-content">
                            ...
                            <?php } ?>
                            <?php /* ---------- 모바일용 컨텐츠 끝 ---------- */ ?>
                            <ul class="navbar-nav navbar-nav-ui">
                                <?php if ($is_admin == 'super' && !G5_IS_MOBILE) { ?>
                                ...
                                <li class="dropdown dropdown-mega-menu d-none d-lg-block dropdown-mega-menu-custom">
                                    <a data-bs-toggle="dropdown" class="nav-link dropdown-toggle" href="#"><i class="fas fa-bars"></i>전체상품</a>
                                    ...
                                    <?php } ?>
                                        <li class="dropdown-submenu">
                                            <a href="<?php echo $menu_2['me_link']; ?>" target="_<?php echo $menu_2['me_target']; ?>" class="dropdown-item nav-link <?php if (isset($menu_2['active']) && $menu_2['active']) echo 'active';?>">
                                                ...
                                                <i class="fas fa-angle-right sub-caret hidden-sm hidden-xs">
                                                <img src="<?php echo EYOOM_THEME_URL; ?>/image/chevron_ic.svg" alt="<?php echo $config['cf_title']; ?>">
                                </i><i class="fas fa-angle-down sub-caret hidden-md hidden-lg"></i>
                                                <?php } ?>
                                            </a>
                                            <?php $index3 = $size3 = 0; ?>
                                            <?php if (isset($menu_2['subsub']) && is_array($menu_2['subsub'])) { $size3 = count($menu_2['subsub']); ?>
