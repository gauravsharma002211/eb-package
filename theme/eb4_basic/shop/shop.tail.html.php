	...
	<footer class="footer footer-custom">
		<div class="container">
			<div class="footer-top">
				...
				<img src="<?php echo EYOOM_THEME_URL; ?>/image/footer-logo.svg" class="footer-logo" alt="<?php echo $config['cf_title']; ?>">
                                       
				</div>
				<div class="footer-right-nav">
				    <a href="javascript:void(0)">카카오톡 채널추가</a>
			...
			<div class="footer-cont-info">
				...
				<?php } ?>
				<div class="footer-section-first footer-section-common">
					<div class="footer-section-first-top">
						<strong class="text-white f-w-600">CS CENTER 1522-2041</strong><span class="text-grey-divider">|</span>
						<strong class="text-white f-w-600">평일 10:00 ~ 17:00 (점심 12:00 ~ 13:00)</strong>
					</div>
					<div class="footer-section-first-bottom">
						<a class="text-grey" href="mailto:<?php echo $bizinfo['bi_cs_email']; ?>"><?php echo $bizinfo['bi_cs_email']; ?></a><span class="text-grey-divider">|</span>
						<span class="text-grey">토요일, 일요일, 공휴일은 휴무입니다. 근무시간 이후 문의는 1:1 문의를 이용해주세요.</span>
				    </div>
				</div>
				<div class="footer-section-second footer-section-common">
					<div class="footer-section-second-top">
					<strong class="text-white f-w-600"><?php echo $bizinfo['bi_company_name']; ?></strong><span class="text-grey-divider">|</span>
					<strong class="text-white f-w-600">대표 : <?php echo $bizinfo['bi_company_ceo']; ?></strong>
					</div>
					<div class="footer-section-second-bottom">
					<span class="text-grey">사업자등록번호 : <?php echo $bizinfo['bi_company_bizno']; ?></span>
					<span class="text-grey-divider">|</span>
					<?php if($bizinfo['bi_company_sellno']) { ?>
					<span class="text-grey">통신판매업번호 : <?php echo $bizinfo['bi_company_sellno']; ?></span>
					<span class="text-grey-divider">|</span>
					<?php } ?>
					<span class="text-grey">주소 : <?php echo $bizinfo['bi_company_zip']; ?> <?php echo $bizinfo['bi_company_addr1']; ?> <?php echo $bizinfo['bi_company_addr2']; ?> <?php echo $bizinfo['bi_company_addr3']; ?></span>
